...
public class SelfcarePrepaidGolifePurchase extends DriverFactory {
	...
	private static Logger logger = LogManager.getLogger(SelfcarePrepaidGolifePurchase.class);
	...
	public void SelfcarePurchaseGolife(String Golife,String msisdn,String Amount,String PaymentType,String Cardnumber) {
