...
public class CRMCustomerSearchPage extends MainUtil {

	private AndroidDriver<?> driver;

	public CRMCustomerSearchPage(AndroidDriver<?> driver) {
		this.driver = driver;
	}
	...
	//@AndroidFindBy(xpath = "(//android.widget.Button[@content-desc=\"MultiBar, tab, 2 of 3\"]/descendant::android.widget.ImageView[1])[1]")
